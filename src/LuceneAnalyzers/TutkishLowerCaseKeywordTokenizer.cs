...
{
    public class TutkishLowerCaseKeywordTokenizer : Tokenizer
    {
        public TutkishLowerCaseKeywordTokenizer(System.IO.TextReader input)
            : base(input)
        {
        ...
        protected TutkishLowerCaseKeywordTokenizer(AttributeSource source, System.IO.TextReader input)
            : base(source, input)
        {
            offsetAtt = AddAttribute<IOffsetAttribute>();
            termAtt = AddAttribute<ITermAttribute>();
        ...
        protected TutkishLowerCaseKeywordTokenizer(AttributeFactory factory, System.IO.TextReader input)
            : base(factory, input)
        {
            offsetAtt = AddAttribute<IOffsetAttribute>();
            termAtt = AddAttribute<ITermAttribute>();
        ...
        {
            return char.ToLower(c, _trCulture);
        }
